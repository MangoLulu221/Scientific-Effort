...
//char CGPass::ID = 0;
// 第三个参数: is_Analysis(是否是分析Pass) -> true 表示它是分析Pass
// 第四个参数: is_CFG_Only(是否只在CFG上运行) -> false 表示它是一个ModulePass
//static RegisterPass<CGPass> X("my-callgraph", "Custom Call Graph Analysis Pass", true, false);
